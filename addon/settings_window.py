    ...
    def __init__(self, parent=None):
        ...
        about_lbl = QLabel(
           ...
           F'<p>You can suggest changes to the Kanji dataset <a href="{KANJI_FORMS_URL}">here</a>.</p>'
            ...
            '<p><a href="https://foosoft.net/projects/yomichan/">Yomichan</a> is used for furigana parsing, and is copyright © 2016-2021 Yomichan Authors and released under the <a href="https://github.com/FooSoft/yomichan/blob/master/LICENSE">GNU General Public License</a>.</p>'

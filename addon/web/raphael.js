			...
			(i = [r(2)]),
				void 0 ===
					(n = function (t) {
						...
						function Ht() {
							return (
								this.x + g + this.y + g + this.width + ' × ' + this.height
							);
						}
								...
								return function (i, n, a) {
									for (
										...
										if ('M' == (l = i[d])[0]) (s = +l[1]), (o = +l[2]);
											...
											if (
												p +
													(h = Xt(s, o, l[1], l[2], l[3], l[4], l[5], l[6])) >
												n
											) {
												if (r && !f.start) {
													if (
							...
							if (u) {
								if (c) (c.initstatus = s), (c.start = new Date() - c.ms * s);
									...
									for (var S in u)
										if (
											u[o](S) &&
											(I[o](S) || i.paper.customAttributes[o](S))
										)
											switch (
												((b[S] = i.attr(S)),
												null == b[S] && (b[S] = j[S]),
						...
						(Wt.animateWith = function (t, r, i, n, a, s) {
							...
							(ne.prototype.repeat = function (t) {
								var e = new ne(this.anim, this.ms);
								return (
									(e.del = this.del), (e.times = _.floor(w(t, 0)) || 1), e
								);
							}),
							...
							(Wt.resume = function (e) {
								for (var r = 0; r < Kt.length; r++)
									if (Kt[r].el.id == this.id && (!e || Kt[r].anim == e)) {
										var i = Kt[r];
										!1 !==
											t('raphael.anim.resume.' + this.id, this, i.anim) &&
								...
								B = function (i, a) {
									if (
										...
										if (a[e]('text')) {
											...
											for (
												p = 0,
													d = (f = o.getElementsByTagName('tspan')).length;
												p < d;
												p++
											)
												p
